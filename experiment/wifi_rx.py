...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Parse CLI Arguments
        ##################################################
        parser = argparse.ArgumentParser(description="Record 802.11 meta-data")
        parser.add_argument('--server', type=str, help='IP of the UDP Server')
        parser.add_argument('--sdr_id', type=str, help="Serial of the SDR recording the frames")
        ...
        # Create the labels list
        self._lo_offset_labels = ('0', '6M', '11M', )
        # Create the combo box
        ...
        if args.server == None:
            ...
            self.blocks_socket_pdu_0 = blocks.socket_pdu('UDP_CLIENT', args.server, '52002', 10000, False)
